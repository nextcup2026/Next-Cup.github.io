    ...
    <header class="sticky top-0 z-50 bg-gray-950/80 backdrop-blur border-b border-white/10">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-gray-900 border-t border-gray-800 absolute w-full left-0 top-full shadow-2xl z-50">
            <div class="flex flex-col px-6 py-4 space-y-4 font-semibold text-lg">
                ...
                <a href="sorteggi_live.html" class="nav-link-mobile text-red-400 font-bold hover:text-red-300 transition flex items-center gap-2 border-b border-gray-800 pb-2" data-page="sorteggi_live.html">Tabellone <span class="relative flex h-3 w-3"><span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span><span class="relative inline-flex rounded-full h-3 w-3 bg-red-500"></span></span></a>
